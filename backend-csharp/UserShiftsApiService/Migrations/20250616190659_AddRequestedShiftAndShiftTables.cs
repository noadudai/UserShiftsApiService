...
{
    /// <inheritdoc />
    public partial class AddRequestedShiftAndShiftTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    UserShiftsPreferenceRequestId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShiftRequests_UserShiftPreferenceRequests_UserShiftsPrefere~",
                        column: x => x.UserShiftsPreferenceRequestId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftRequests_UserShiftsPreferenceRequestId",
                table: "ShiftRequests",
